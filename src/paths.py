...
# Nomes dos arquivos de Taxa de Distorção
file_taxa_distorcao_2019 = 'TDI_MUNICIPIOS_2019.xlsx' 
file_taxa_distorcao_2020 = 'TDI_MUNICIPIOS_2020.xlsx'
file_taxa_distorcao_2021 = 'TDI_MUNICIPIOS_2021.xlsx'
file_taxa_distorcao_2022 = 'TDI_MUNICIPIOS_2022.xlsx'
...
diretorio_IDEB = RAW_DATA_DIR / 'INEP' / file_ideb
diretorio_PROJ_IA = RAW_DATA_DIR / 'proj_IA' / file_proj_IA
diretorio_PIB = RAW_DATA_DIR / 'PIB' / file_pib

# Caminhos completos para os arquivos de Taxa de Distorção
diretorio_TAXA_DISTORCAO_2019 = RAW_DATA_DIR / 'INEP' / file_taxa_distorcao_2019
diretorio_TAXA_DISTORCAO_2020 = RAW_DATA_DIR / 'INEP' / file_taxa_distorcao_2020
diretorio_TAXA_DISTORCAO_2021 = RAW_DATA_DIR / 'INEP' / file_taxa_distorcao_2021
diretorio_TAXA_DISTORCAO_2022 = RAW_DATA_DIR / 'INEP' / file_taxa_distorcao_2022
diretorio_TAXA_DISTORCAO_2023 = RAW_DATA_DIR / 'INEP' / file_taxa_distorcao_2023
